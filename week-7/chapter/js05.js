...
function createLightbox() {
  ...
  /*DRY function to do the same as below (part 1)
  function designEl(childEl) {
    lightBox.appendChild(childEl);
    childEl.id = Object.keys({elID})[0];
  }
  ...
  const lbEls = [lbTitle, lbCounter, lbPrev, lbNext, lbPlay, lbImages];
  for (let i=0; i<lbEls.length; i++) {
    designEl(lbEls[i]);
  }
  */
  ...
  //Function to create overlay/modal for full screen images
